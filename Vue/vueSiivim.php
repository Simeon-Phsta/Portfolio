...
<!-- début texte page Siivim -->

<main class="container">
    <div class="row contenu">
        <section class="col-md-7 Siivim">
            <p>
                Le Siivim de Nevers<br><br>
    ...
    <div class="row contenu">
        <section class="col-md-7 Natural_Connect">
            <p>
    ...
    <div class="row contenu">
        <section class="col-md-7 Cap_collectif">
            <p>
    ...
    <div class="row contenu">
        <section class="col-md-7 Legendr">
            <p>        
                <br><br> Legendr <br>
    ...
    <div class="row contenu">
        <section class="col-md-7  Job_pack">
            <p>
                <br><br> Job pack <br>
    ...
    <div class="row contenu">
        <section class="col-md-7 Interstis">
            <p>
                <br><br> Interstis <br>
    ...
    <div class="row contenu">
        <section class="col-md-7 Proxity">
            <p>
                <br><br> Proxity <br>
